...
echo \Sphp\Html\TagFactory::span('foo');
echo \Sphp\Html\TagFactory::a('#', 'hyperlink', '_self');
echo \Sphp\Html\TagFactory::time(new \DateTime(), 'foo');

echo \Sphp\Html\TagFactory::option('foo', 'foo');
echo \Sphp\Html\TagFactory::textInput('foo', 'foo');
