...
$parsedYaml = Manual\codeModalFromString('<i class="fab fa-php"></i> PHP array', print_r(Parser::fromFile('manual/snippets/example.yml'), true), 'text', 'YAML-file as parsed PHP array');
