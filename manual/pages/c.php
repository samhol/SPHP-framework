...
echo "<pre>";
$cd->getInfo()->setBirthday('Sami Holck');
$cd->getInfo()->setHoliday('Ball licking day');
//echo $cd;
...
$cd1->getInfo()->setBirthday('Pussy pounder');
$cd1->getInfo()->setBirthday('Homo Fucker');
$cd1->getInfo()->setHoliday('Ass licking day');
