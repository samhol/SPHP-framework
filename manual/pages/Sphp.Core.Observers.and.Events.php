...
CodeExampleAccordionBuilder::visualize("Sphp/Core/Events/EventManager.php", "text", false);
...
CodeExampleAccordionBuilder::visualize("Sphp/Core/ObservableSubjectTrait.php", "text", false);
