...
CodeExampleAccordion::visualize(EXAMPLE_DIR . "Sphp/Util/Arrays1.php", "php", false);
echo $parsedown->text(<<<MD
$arraysClass methods for manipulating array properties and creating new arrays.
MD
);
CodeExampleAccordion::visualize(EXAMPLE_DIR . "Sphp/Util/Arrays2.php", "php", false);
echo $parsedown->text(<<<MD
...
CodeExampleAccordion::visualize(EXAMPLE_DIR . "Sphp/Util/Arrays3.php", "php", false);
