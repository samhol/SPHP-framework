...
class HttpErrorViewer implements ContentInterface {
  ...
  public function getHtml(): string {
    ...
    $i25 = Img::scaleToFit($path, 25, 25)->addCssClass('grow')->setLazy()->setAlt('25px');
    $i50 = Img::scaleToFit($path, 50, 50)->addCssClass('grow')->setLazy()->setAlt('50px');
    $i100 = Img::scaleToFit($path, 100, 100)->addCssClass('grow')->setLazy()->setAlt('100px');
    $i150 = Img::scaleToFit($path, 150, 150)->addCssClass('grow')->setLazy()->setAlt('150px');
