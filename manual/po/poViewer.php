...
$accordion->addCssClass('sphp');
$accordion->allowMultiExpand();
...
$fileHandler = new \Sepia\PoParser\SourceHandler\FileSystem(__DIR__ . "/../../sphp/locale/fi_FI/LC_MESSAGES/Sphp.Defaults.po");
