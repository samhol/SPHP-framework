...
$deviconFontModal->getPopup()
        ->addCssClass('icon-example-popup', 'devicons')
        ->setOption('multiple-opened', true)
        ->layout()
        ->setSize('large');
$fontTrigger = $deviconFontModal->getTrigger()->addCssClass('icon-popup-trigger', 'shadow', 'radius');
$fontTrigger->setAttribute('data-url', '/manual/snippets/icons/devicon/font-version.php');
...
$svgTrigger->setAttribute('data-url', '/manual/snippets/icons/devicon/svg-version.php');
