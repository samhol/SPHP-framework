...
$objects = new RecursiveIteratorIterator(new RecursiveDirectoryIterator('/home/int48291/public_html/data.samiholck.com/svg/devicons'));
$title = 'foo';
