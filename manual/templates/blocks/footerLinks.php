...
$grid->append((new Menu())->vertical()
                ...
                ->appendRuler()
                ->appendLink('https://jquery.com/', 'jQuery')
...
$grid->append((new Menu())->vertical()
                ...
                ->appendLink('https://framework.zend.com/', 'Zend')
                ->appendLink('https://github.com/erusev/parsedown-extra', 'Symfony' . Icons::devicon('symfony-original'))
                ->appendLink('http://www.doctrine-project.org/', 'Doctrine' . Icons::devicon('doctrine-plain'))
                ->appendText('Databases' . Icons::fontAwesome('fa-database'))
                ->appendLink('https://www.mysql.com/', 'MySQL')
                ->appendLink('http://www.postgresql.org/', 'PostgreSQL')
