...
$grid->append((new Menu())->vertical()
                ->appendText('Who uses it?' . FontAwesome::users())
                ...
                ->appendText('Framework APIs' . FontAwesome::book())
                ->appendLink('http://playground.samiholck.com/API/sami/', FontAwesome::php() . 'PHP API')
                ->appendLink('http://playground.samiholck.com/API/jsdoc/', FontAwesome::js() . 'JavaScript API'));
$grid->append((new Menu())->vertical()
                ->appendText('JavaScript ' . FontAwesome::js())
...
$grid->append((new Menu())->vertical()
                ->appendText('PHP' . FontAwesome::php())
                ...
                ->appendText('Databases' . FontAwesome::database())
