...
namespace Sphp\Proxies\__CG__\Sphp\Db;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Address extends \Sphp\Db\Address implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sphp\\Db\\Address' . "\0" . 'id', '' . "\0" . 'Sphp\\Db\\Address' . "\0" . 'street', '' . "\0" . 'Sphp\\Db\\Address' . "\0" . 'zip', '' . "\0" . 'Sphp\\Db\\Address' . "\0" . 'city', '' . "\0" . 'Sphp\\Db\\Address' . "\0" . 'country'];
        }
