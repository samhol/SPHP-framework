...
namespace Sphp\Tests\Foundation\Sites\Core;
...
class DataOptionToolsTest extends \PHPUnit\Framework\TestCase {
  ...
  /**
   * @covers \Sphp\Foundation\Sites\Core\DataOptions\DataOptionTools::toDataAttribute
   * @dataProvider toDataAttributeData
   *
   * @param string $raw
   * @param string $dataAttrName
   */
  public function testToDataAttribute(string $raw, string $dataAttrName): void {
