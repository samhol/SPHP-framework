...
interface Menu extends Component {
   ...
   *
   * @param  bool $nested true for nesting and false for unnesting
   ...
   *
   * @param  bool $vertical true for vertical orientation and false for horizontal
   * @return $this for a fluent interface
   */
   ...
   *
   * @return bool true if the menu is vertical, otherwise false
   */
   ...
   *
   * @return bool true if the menu is set as active, otherwise false
   */
