 ...
 * @link    https://foundation.zurb.com/sites/docs/button.html Foundation Buttons
 * @license https://opensource.org/licenses/MIT The MIT License
 * @filesource
 */
interface ButtonInterface extends CssClassifiableContent, Colourable {
   ...
   * @link   https://foundation.zurb.com/sites/docs/button.html#sizing Button Sizing
   */
   ...
   * This is purely a visual style
   *
   * @param  bool $disabled true for `disabled` style, otherwise false
   * @return $this for a fluent interface
