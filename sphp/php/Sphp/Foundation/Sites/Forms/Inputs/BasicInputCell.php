...
class BasicInputCell extends AbstractCell implements InputCell {
   ...
   * @param iterable|null $opt
   * @param type $selectedValues
   * @param array $layout
   * @return BasicInputCell a new instance containing an Email input
   */
  public static function select(?string $name = null, ?iterable $opt = null, $selectedValues = null, array $layout = ['small-12']): BasicInputCell {
    $input = new Select($name, $opt);
