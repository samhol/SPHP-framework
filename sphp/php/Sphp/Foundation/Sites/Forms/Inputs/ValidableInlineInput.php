 ...
 * 
 * 
 * @method \Sphp\Foundation\Sites\Forms\Inputs\ValidableInlineInput number(string $name = null, $value = null) creates a new `number` input
 * @method \Sphp\Foundation\Sites\Forms\Inputs\ValidableInlineInput text(string $name = null, $value = null) creates a new `text` input
 * @method \Sphp\Foundation\Sites\Forms\Inputs\ValidableInlineInput textarea(string $name = null, $value = null) creates a new `textarea` input
 * @method \Sphp\Foundation\Sites\Forms\Inputs\ValidableInlineInput select(string $name = null, $value = null) creates a new `select` input
 *
