 ...
 * @link    https://foundation.zurb.com/sites/docs/forms.html#checkboxes-and-radio-buttons Foundation Checkboxes and Radio Buttons
 * @license https://opensource.org/licenses/MIT The MIT License
 * @filesource
 */
class Choiceboxes extends AbstractCell implements Input, Cell {
   ...
   * @link   https://www.w3schools.com/tags/tag_legend.asp legend tag
   */
