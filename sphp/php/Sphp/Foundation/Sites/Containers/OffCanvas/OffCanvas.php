 ...
 * @link    https://foundation.zurb.com/docs/components/offcanvas.html Foundation Off-canvas
 * @license https://opensource.org/licenses/MIT The MIT License
 * @filesource
 */
class OffCanvas extends AbstractComponent {
  ...
  public function __construct(int $position) {
    ...
    $this->offCanvasContent->attributes()->forceVisibility('data-off-canvas-content');
  }
