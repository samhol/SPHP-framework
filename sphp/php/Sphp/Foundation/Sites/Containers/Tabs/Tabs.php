...
class Tabs extends AbstractContent implements JavaScriptComponent, IteratorAggregate, TraversableContent {
  ...
  public function __construct() {
    ...
    $this->controllers->attributes()->forceVisibility('data-tabs');
    $this->content = new Div();
    $this->content->attributes()->setAttribute('data-tabs-content', $this->controllers->identify());
    $this->controllers->attributes()->setInstance($this->options = new MapAttribute('data-options'));
  }
 ...
 public function setOption(string $name, $value) {
   ...
   * 
   * @param  bool $match true for matching heights
   ...
   * @return bool true if a tab exits at the given index
   */
