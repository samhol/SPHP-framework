 ...
 * @link    https://foundation.zurb.com/sites/docs/dropdown.html Foundation Dropdown
 * @license https://opensource.org/licenses/MIT The MIT License
...
class Dropdown extends AbstractContent implements Component {
  ...
  public function __construct($trigger, $dropdown) {
    ...
    $this->dropdown->attributes()->setInstance($this->options = new MapAttribute('data-options'));
    $this->dropdown->identify();
    $this->dropdown->cssClasses()->protectValue('dropdown-pane');
    $this->dropdown->attributes()->forceVisibility('data-dropdown');
