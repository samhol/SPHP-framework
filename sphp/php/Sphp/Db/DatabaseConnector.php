...
/**
 * Obtains a singelton Database instance for the given database connection
 *
...
class DatabaseConnector {
  ...
  /**
   * Obtains a singelton Database instance for given database connection
   *
   ...
   */
  public static function obtain($dsn, $username, $password) {
