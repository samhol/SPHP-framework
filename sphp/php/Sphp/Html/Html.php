...
class Html extends AbstractComponent implements IteratorAggregate, TraversableContent, ContentParser {
  ...
  public function useFontAwesome() {
    $this->head()->set((new ScriptSrc('https://use.fontawesome.com/releases/v5.7.1/js/all.js'))
                    ->setIntegrity('sha384-eVEQC9zshBn0rFj4+TU78eNA19HMNigMviK/PU/FFjLXqa/GKPgX58rvt5Z8PLs7')
                    ->setDefer(true));
    return $this;
  }
  ...
  public function enableSPHP() {
    $this->body()->scripts()->appendSrc('http://playground.samiholck.com/sphp/javascript/dist/all.js');
    return $this;
  }
