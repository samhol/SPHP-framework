...
use Sphp\Html\Foundation\Sites\Navigation\Bars\TopBar;
use Sphp\Html\Foundation\Sites\Navigation\ResponsiveMenu;
use Sphp\Html\Foundation\Sites\Navigation\Factory\MenuBuilder;
...
class TopBarBuilder {
  ...
  protected function buildMenu(array $data): Menu {
    $mb = new MenuBuilder();
