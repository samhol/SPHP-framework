 ...
 * @link    https://www.w3schools.com/tags/tag_p.asp w3schools HTML API
...
class Paragraph extends ContainerTag {
  ...
  public function appendMarkdown(string $md , bool $d = false) {
    $parsed = ParseFactory::markdown()->parseString($md, true);
    $this->append($parsed);
    return $this;
  }
