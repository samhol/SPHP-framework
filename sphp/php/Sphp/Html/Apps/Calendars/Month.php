 ...
 * @filesource
 */
class Month extends AbstractComponent {
  ...
  public function __construct($year = null, $month = null) {
    ...
    //$this->div = new \Sphp\Html\Container();
  ...
  protected function createTable($dt) {
    ...
    $table->append($this->parseWeeks($dt));
    return $table;
  }

  protected function parseWeeks(DateTimeInterface $dt) {
    $div = new \Sphp\Html\Container();
  ...
  public function contentToString(): string {
    return $this->createTable($this->dateTime)->getHtml();
  }
